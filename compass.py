...
class CompassWidget(QWidget):
    ...
    def drawMarkings(self, painter):
        ...
        painter.setPen(Qt.white) #self.palette().color(QPalette.Shadow)
    ...
    def drawNeedle(self, painter):
        ...
        painter.setBrush(Qt.black) #stand er colour
        ...
        painter.setBrush(Qt.blue) #self.palette().brush(QPalette.Blue)
